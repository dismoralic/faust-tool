...
async def help_command(event):
    help_text = "🛠 <b>Доступные команды faust tool:</b>\n"
    help_text += "⚡️ <b>.ping</b> - Проверка пинга\n"
    help_text += "⚡️ <b>.uptime</b> - Время работы faust tool\n"
    help_text += "⚡️ <b>.info</b> - Информация о пользователе (реплей)\n"
    help_text += "⚡️ <b>.note</b> - Оставить заметку о пользователе (реплей)\n"
    help_text += "⚡️ <b>.spam [кол-во] [текст]</b> - Спам\n"
    help_text += "⚡️ <b>.phones</b> - Сбор слитых номеров\n"
    help_text += "⚡️ <b>.sv</b> - Сохранение самоудаляющегося медиа\n"
    help_text += "⚡️ <b>.video</b> - Скачивание видео\n"
    help_text += "⚡️ <b>.help</b> - Список команд\n"
    help_text += "⚡️ <b>.admin help</b> - Команды администратора чата\n"
    help_text += "⚡️ <b>.trns help</b> - Перевод ваших сообщений в реальном времени\n"
    help_text += "⚡️ <b>.dlmod</b> - Установка faust-модуля (ответом на сообщение)\n"
    help_text += "⚡️ <b>.respond help</b> - Автоответчик\n"
    help_text += "⚡️ <b>.call</b> - Призывает первых 100 участников чата\n"
    help_text += "⚡️ <b>.update</b> - Обновление до последней версии инструмента\n"
    help_text += "\n"
    help_text += "<i>Лишь только идущий осилит дорогу...</i>\n"
    help_text += "ㅤㅤ<i>Лишь тот, кто найдет в себе силу — шагнуть 🕊</i>\n"
    help_text += "\n"
    help_text += "<b>Создатель:</b> <code>angel_xranytel</code>\n"
    help_text += "<code>2.0.3v</code>\n"
