...
async def help_command(event):
    ...
    help_text += "⚡️ **.info** - Информация о пользователе (реплей)\n"
    help_text += "⚡️ **.note** - Оставить заметку о пользователе (реплей, дополнение к модулю выше)\n"
