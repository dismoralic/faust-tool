...
async def help_command(event):
    ...
    help_text += "⚙️ **.voice** - Обработка речи из голосовых или видео сообщений. (RUS, ENG, KZ)\n"
    help_text += "⚙️ **.text** - Обработка текста из фотографии или стикера. (RUS, ENG)\n"
    help_text += "⚙️ **.call <число>** - Призывает участников чата. (По умолчанию - 100)\n\n"
    help_text += "⚙️ **.dlmod <реплей>** - Установка faust-модуля. (ответом на сообщение)\n"
    help_text += "⚙️ **.update** - Полное обновление инструмента до последней версии.\n\n"
    help_text += " **.faust** - Информация об инструменте.\n"
